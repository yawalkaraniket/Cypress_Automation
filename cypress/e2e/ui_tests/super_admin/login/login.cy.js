...
describe('Verify user login', () => {
    ...
    beforeEach(() => {
        cy.visit(environmentValues.superAdmin.url)
    })

    /**
     * Scenario: User should be able to login.
     * Test Group: Sanity, SuperAdmin, Regression
     * Steps: 
     ...
     */
    it('Verify user is able to login successfully.', { tags: ['@sanity', '@SuperAdmin', '@Regression'] }, () => {
